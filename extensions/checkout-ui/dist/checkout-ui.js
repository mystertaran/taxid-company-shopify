...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const [checked, setChecked] = (0, import_react15.useState)(false);
    const [taxId, setTaxId] = (0, import_react15.useState)("");
    const [companyName, setCompanyName] = (0, import_react15.useState)("");
    ...
    (0, import_react15.useEffect)(() => {
      if (customerTaxId && customerTaxId.value) {
        setTaxId(customerTaxId.value);
      }
      if (customerCompanyName && customerCompanyName.value) {
        setCompanyName(customerCompanyName.value);
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked, onChange: handleCheckboxChange, children: translate("invoiceCheckbox") }),
      checked && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
